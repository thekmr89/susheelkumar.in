      ...
      <div className="max-w-7xl lg:mt-0 mt-[25vh] mx-auto px-6 lg:px-12 relative z-10 w-full pointer-events-none">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          <div className="lg:col-span-7  m-[0_auto] lg:m-0 max-w-xl xl:max-w-2xl space-y-6 text-center lg:text-start ">
            ...
            <div className="pointer-events-auto pt-2 flex flex-wrap lg:justify-start justify-center items-center gap-4 font-fredoka text-xs font-bold text-black">
